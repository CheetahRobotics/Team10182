...
This is Version 3.0 of OpenCV downloaded from http://opencv.org/downloads.html. 

2. OpenCV-AndroidStudioBuild

Using the code in the sdk/java directory of the first directory, I *roughly* followed the instructions here: http://stackoverflow.com/a/27421494, (up thru step 3), and then built the .aar file. 
